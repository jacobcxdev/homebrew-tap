...
cask "cq" do
  ...
  on_macos do
    on_arm do
      sha256 "8bf72320d77075da0058db0e405c42360503d0eba8220a593577807a85cc08c1"
      url "https://github.com/jacobcxdev/cq/releases/download/v#{version}/cq_#{version}_darwin_arm64.tar.gz"
    end
    on_intel do
      sha256 "1cc3cbcec0f51febac61d112c99f9747b38041e67edd8f1d044400326775c7f6"
      url "https://github.com/jacobcxdev/cq/releases/download/v#{version}/cq_#{version}_darwin_amd64.tar.gz"
    end
  end
  on_linux do
    on_arm do
      sha256 "18c4de83f24e8d00672f4fe7b473d106c7c045ba5ff7f99e984dd1c152e7e78f"
      url "https://github.com/jacobcxdev/cq/releases/download/v#{version}/cq_#{version}_linux_arm64.tar.gz"
    end
    on_intel do
      sha256 "d4e719190e70b27ba8d6f9548a232d7a2508066c07a2f0e2555faaae30b82d5e"
